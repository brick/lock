...
/**
 * Controls locks in a separate process.
 */
class RemoteLock
{
    ...
    public function tryAcquireWithTimeout(string $lockName, int $seconds): void
    {
        $this->sendCommand('tryAcquireWithTimeout', [$lockName], timeoutSeconds: $seconds);
    }
